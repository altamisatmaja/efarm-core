            ...
            <ol class="flex items-center gap-4">
                ...
                <li class="inline-flex">
                    <div
                        ...
                        <a class="text-textbase"  href="{{ route('admin.partner.from.submission') }}"> Pengajuan partner  </a>
                    </div>
                </li>
            </ol>
        </div>
            ...
            <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                    ...
                    <div class="relative w-full mb-5 max-w-full flex-grow flex-1">
                        <h3 class="font-semibold text-textbase text-xl">Daftar pengajuan partner</h3>
                    </div>
