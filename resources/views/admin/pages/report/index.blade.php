            ...
            <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                    ...
                    <form action="">
                        <div>
                            <div>
                                <label for="dari" class="text-sm font-medium text-gray-700 block mb-2">Dari</label>
                                <input type="date" name="dari" id="dari" value="{{ request()->input('dari') }}">
                            </div>
                            <div>
                                <label for="sampai" class="text-sm font-medium text-gray-700 block mb-2">Sampai</label>
                ...
                $.ajax({
                    ...
                    success: function({
                        ...
                        <tr>
                                ...
                                <td class="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">${val.nama_partner}</td>
                                <td class="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">${val.jumlah_dibeli}</td>
                                <td class="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">${val.nama_product}</td>
                                <td class="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">${rupiah(val.harga_product)}</td>
                                <td class="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">${val.total_qty}</td>
                            </tr>
                        `;
                        });
                        $('tbody').append(row);
