            ...
            <ol class="flex items-center gap-4">
                ...
                <li class="inline-flex">
                    <div
                        ...
                        <a class="lowecase" href="{{ route('admin.category.edit', $categoryproduct->slug_kategori_product) }}"> Ubah kategori <span class="lowercase">{{ $categoryproduct->nama_kategori_product }}</span> </a>
                    </div>
                </li>
            </ol>
        </div>
                ...
                <div class="w-full bg-whitemx-auto rounded">
                    <div class="py-4 text-left">
                        ...
                        <div class="flex justify-between items-center pb-3">
                            <p class="text-2xl font-bold text-textbase">Ubah kategori produk</p>
                        </div>
                        <form class=""
