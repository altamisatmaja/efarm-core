            ...
            <div class="lg:w-full mx-auto flex flex-wrap">
                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    @foreach ($product->partner as $partners)
                        <h2 class="text-sm title-font text-gray-500 tracking-widest">Diupload oleh
                            {{ $partners->nama_partner }}</h2>
                    @endforeach
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">{{ $product->nama_product }}</h1>
                    <div class="flex mb-4">
                        <span class="flex items-center">
                            ...
                            @endphp
                            <span class="text-gray-600 ml-3">{{ $banyak_reviewers }} Reviews</span>
                        </span>
                    </div>
                    <p class="leading-relaxed">{{ $product->deskripsi_product }}</p>
