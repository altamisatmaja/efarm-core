                ...
                <div class="rounded-t mb-0 px-4 py-3 border-0">
                    <div class="flex flex-wrap items-center">
                        <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                            <h3 class="font-semibold text-textbase text-xl">Review dari pengguna</h3>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach ($review as $reviews)
                                    <tr>
                                        ...
                                        <td class="px-4 py-4 text-sm text-textbase">{{ $reviews->products->nama_product }}</td>
                                        <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                            <div
                                                class="inline-flex items-center py-1 rounded-full text-textbase">
                                                <h2 class="text-sm font-normal">{{ $reviews->user->nama }}</h2>
                                            </div>
                                        </td>
                                        <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                            <div
                                                class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 text-textbase">
                                                <h2 class="text-sm font-normal">{{ $reviews->rating }}</h2>
                                            </div>
                                        </td>
                                        <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                            <div
