        ...
        <div class="relative flex flex-col bg-white w-full h-64 rounded-lg">
            <div class="bg-gray-50  rounded-3xl">
                <div class="px-14 py-10 flex flex-col">
                    ...
                    <buton class="bg-primarybase cursor-pointer w-2/6 mt-4 font-semibold rounded-xl px-8 py-6 text-white text-4xl">
                        Hubungi kami 🤝
                    </buton>
                    </div>
                </div>
            ...
            <div class="max-w-7xl px-4 mx-auto text-black">
                <div class="text-center flex justify-between items-center">
                    ...
                    <div class="flex justify-center">
                        <div class="flex items-center border w-auto rounded-lg px-4 py-2">
