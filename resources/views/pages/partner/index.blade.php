    ...
    <div>
                ...
                <div class="mx-auto max-w-2xl text-center">
                    ...
                    <div class="mt-5 max-w-3xl">
                        <p class="text-lg text-textbase">Kelola peternakan, jual hewan ternak, beli hewan ternak
                            dengan berbagai layanan yang tersedia di Ternak Express.</p>
                    </div>
        ...
        <section class="flex flex-col py-20">
            <h1 class="block font-bold text-textbase text-center text-5xl md:text-5xl lg:text-6xl">
                Rekam Jejak <span class="text-primarybase ">Ternak Express</span>
            </h1>
            <div
                ...
                <div
                    ...
                    <div class="flex flex-row justify-center items-center">
                        ...
                        <p class="font-bold text-3xl sm:text-4xl lg:text-5xl text-textbase leading-9 text-primary ml-2">412+
                        </p>
                    </div>
                ...
                <div
                    ...
                    <div class="flex flex-row justify-center items-center">
                        <svg class="w-[35px] h-[35px] md:w-[50px] md:h-[50px]" viewBox="0 0 51 50" fill="none"
                            ...
                            <g clip-path="url(#a)">
                                <path
                                    ...
                                    stroke="#AAC14C" stroke-width="4.341" stroke-linecap="round" stroke-linejoin="round">
                                </path>
                            </g>
                            <defs>
                                <clipPath id="a">
                        ...
                        <p class="font-bold text-3xl sm:text-4xl lg:text-5xl leading-9 text-textbase text-primary ml-2">4.9
                        </p>
                    </div>
                    <p class="font-semibold text-lg sm:text-lg leading-6 mt-3 md:mt-6 text-textbase text-center">Rating di
                        Google Maps
                    </p>
                </div>
                <div
                    ...
                    <div class="flex flex-row justify-center items-center">
                        ...
                        <p class="font-bold text-3xl sm:text-4xl lg:text-5xl leading-9 text-textbase text-primary ml-2">
                            1000+</p>
                    </div>
                    <p class="font-semibold text-lg sm:text-lg leading-6 mt-3 text-textbase md:mt-6 text-center">Total
                        Pelanggan
                    </p>
                </div>
                <div
                    ...
                    <p class="font-semibold text-lg sm:text-lg leading-6 mt-3 md:mt-6 text-textbase text-center">Pelanggan
                        2023</p>
                </div>
            </div>
        </section>
        ...
        <section class="bg-gray-50 py-12 pb-32 sm:py-10 lg:py-10 xl:py-10">
            <div class="mx-auto max-w-7xl ">
                <div class="text-center">
                    <p class="text-lg font-semibold text-textbase">Cara menjadi Partner Ternak Express?</p>
                    <h2 class="mt-6 text-6xl font-bold tracking-tight text-textbase sm:text-4xl lg:text-5xl">Hanya 4
            ...
            <ul class="basis-1/2">
                <li>
                    <button
                        ...
                        <span class="flex-1 text-textbase text-base-content">Bagaimana cara memesan hewan ternak di
                            platform ini?</span>
                    ...
                    <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden"
                        ...
                        <div class="pb-5 leading-relaxed">
                            <div class="space-y-2 leading-relaxed">Pengguna dapat memesan hewan ternak melalui platform
                                kami dengan cara mendaftar sebagai pengguna, memilih hewan yang diinginkan, dan melakukan
                                pembayaran melalui fitur payment secara online</div>
                        </div>
                    </div>
                </li>
                <li>
                    <button
                        class="relative flex gap-2 items-center w-full py-5 text-base font-semibold text-left border-t md:text-lg border-base-content/10"
                        aria-expanded="false" onclick="toggleFAQ(this)">
                        <span class="flex-1 text-textbase text-base-content">Apakah ada jaminan kesehatan dan kebersihan
                            hewan yang dibeli?
                        </span>
                        <svg class="flex-shrink-0 w-4 h-4 ml-auto fill-current" viewBox="0 0 16 16"
                            xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden"
                        style="transition: max-height 0.3s ease-in-out 0s;">
                        <div class="pb-5 leading-relaxed">
                            <div class="space-y-2 leading-relaxed">Kami memastikan bahwa semua hewan yang kami jual telah
                                melewati proses pemeriksaan kesehatan yang ketat oleh tenaga profesional. Kami juga
                                memastikan kebersihan dan kesejahteraan hewan sebelum pengiriman</div>
                        </div>
                    </div>
                </li>
                <li>
                    <button
                        class="relative flex gap-2 items-center w-full py-5 text-base font-semibold text-left border-t md:text-lg border-base-content/10"
                        aria-expanded="false" onclick="toggleFAQ(this)">
                        <span class="flex-1 text-textbase text-base-content">Bagaimana proses pengiriman hewan yang telah
                            pengguna pesan?</span>
                        <svg class="flex-shrink-0 w-4 h-4 ml-auto fill-current" viewBox="0 0 16 16"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect y="7" width="16" height="2" rx="1"
                    ...
                    <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden"
                        style="transition: max-height 0.3s ease-in-out 0s;">
                        <div class="pb-5 leading-relaxed">
                            <div class="space-y-2 leading-relaxed">Setelah pembayaran dikonfirmasi, partner akan mengatur
                                pengiriman hewan tersebut sesuai dengan permintaan Anda. Kami bekerja sama dengan penyedia
                                jasa pengiriman terpercaya untuk memastikan hewan tiba dengan aman dan tepat waktu</div>
                        </div>
                    </div>
                </li>
                <li>
                    <button
                        class="relative flex gap-2 items-center w-full py-5 text-base font-semibold text-left border-t md:text-lg border-base-content/10"
                        aria-expanded="false" onclick="toggleFAQ(this)">
                        <span class="flex-1 text-textbase text-base-content">Bagaimana saya bisa menjadi mitra atau penjual
                            di platform ini?
                        </span>
                        <svg class="flex-shrink-0 w-4 h-4 ml-auto fill-current" viewBox="0 0 16 16"
                            xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden"
                        style="transition: max-height 0.3s ease-in-out 0s;">
                        <div class="pb-5 leading-relaxed">
                            <div class="space-y-2 leading-relaxed">Untuk menjadi mitra atau penjual di platform kami, Anda
                                dapat mendaftar melalui fitur <span class="font-semibold text-primarybase"><a
                                        href="{{ route('partner.submission') }}">Daftar sebagai Partner</a></span> di
                                website kami. Tim kami akan menghubungi Anda untuk proses selanjutnya</div>
                        </div>
                    </div>
                </li>
                <li>
                    <button
                        class="relative flex gap-2 items-center w-full py-5 text-base font-semibold text-left border-t md:text-lg border-base-content/10"
                        aria-expanded="false" onclick="toggleFAQ(this)">
                        <span class="flex-1 text-textbase text-base-content">Apakah ada persyaratan khusus untuk menjadi
                            mitra atau penjual? </span>
                        <svg class="flex-shrink-0 w-4 h-4 ml-auto fill-current" viewBox="0 0 16 16"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect y="7" width="16" height="2" rx="1"
                                class="transform origin-center transition duration-200 ease-out false"></rect>
                    ...
                    <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden"
                        style="transition: max-height 0.3s ease-in-out 0s;">
                        <div class="pb-5 leading-relaxed">
                            <div class="space-y-2 leading-relaxed">Kami meminta calon mitra atau penjual untuk memenuhi
                                persyaratan tertentu, termasuk memiliki izin usaha yang sah dan mematuhi standar
                                kesejahteraan hewan yang ditetapkan</div>
                        </div>
                    </div>
                </li>
                <li>
                    <button
                        class="relative flex gap-2 items-center w-full py-5 text-base font-semibold text-left border-t md:text-lg border-base-content/10"
                        aria-expanded="false" onclick="toggleFAQ(this)">
                        <span class="flex-1 text-textbase text-base-content">Bagaimana cara saya mengelola dan memperbarui
                            produk yang saya jual di platform ini?</span>
                        <svg class="flex-shrink-0 w-4 h-4 ml-auto fill-current" viewBox="0 0 16 16"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect y="7" width="16" height="2" rx="1"
                                class="transform origin-center transition duration-200 ease-out false"></rect>
                    ...
                    <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden"
                        style="transition: max-height 0.3s ease-in-out 0s;">
                        <div class="pb-5 leading-relaxed">
                            <div class="space-y-2 leading-relaxed">Setelah Anda menjadi mitra atau penjual, Anda akan
                                memiliki akses ke dashboard khusus di mana Anda dapat mengelola inventaris produk Anda,
                                termasuk pembaruan harga, stok, dan deskripsi produk</div>
                        </div>
                    </div>
                </li>
                <li>
                    <button
                        class="relative flex gap-2 items-center w-full py-5 text-base font-semibold text-left border-t md:text-lg border-base-content/10"
                        aria-expanded="false" onclick="toggleFAQ(this)">
                        <span class="flex-1 text-textbase text-base-content">Apa manfaat menjadi mitra atau partner di
                            platform ini? </span>
                        <svg class="flex-shrink-0 w-4 h-4 ml-auto fill-current" viewBox="0 0 16 16"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect y="7" width="16" height="2" rx="1"
                    ...
                    <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden"
                        style="transition: max-height 0.3s ease-in-out 0s;">
                        <div class="pb-5 leading-relaxed">
                            <div class="space-y-2 leading-relaxed">Sebagai mitra atau partner, Anda akan mendapatkan akses
                                ke pasar yang lebih luas dan mendapat eksposur lebih besar bagi produk Anda. Selain itu,
                                kami juga menyediakan dukungan pemasaran dan promosi untuk membantu meningkatkan penjualan
                                Anda</div>
                        </div>
                    </div>
                </li>
                <li>
                    <button
                        class="relative flex gap-2 items-center w-full py-5 text-base font-semibold text-left border-t md:text-lg border-base-content/10"
                        aria-expanded="false" onclick="toggleFAQ(this)">
                        <span class="flex-1 text-textbase text-base-content">Apakah ada biaya atau komisi yang perlu saya
                            bayarkan sebagai mitra atau partner?</span>
                        <svg class="flex-shrink-0 w-4 h-4 ml-auto fill-current" viewBox="0 0 16 16"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect y="7" width="16" height="2" rx="1"
                                class="transform origin-center transition duration-200 ease-out false"></rect>
                    ...
                    <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden"
                        ...
                        <div class="pb-5 leading-relaxed">
                            <div class="space-y-2 leading-relaxed">
                                Kami tidak mengenakan biaya pendaftaran atau biaya bulanan kepada mitra atau partner kami.
                                Kami mengambil komisi yang wajar dari setiap transaksi yang berhasil dilakukan melalui
                                platform kami</div>
                        </div>
                    </div>
                </li>
                <li>
                    <button
                        class="relative flex gap-2 items-center w-full py-5 text-base font-semibold text-left border-t md:text-lg border-base-content/10"
                        aria-expanded="false" onclick="toggleFAQ(this)">
                        <span class="flex-1 text-textbase text-base-content">Apakah saya bisa menentukan harga sendiri
                            untuk produk yang saya jual di platform ini?</span>
                        <svg class="flex-shrink-0 w-4 h-4 ml-auto fill-current" viewBox="0 0 16 16"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect y="7" width="16" height="2" rx="1"
                                class="transform origin-center transition duration-200 ease-out false"></rect>
                    ...
                    <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden"
                        style="transition: max-height 0.3s ease-in-out 0s;">
                        <div class="pb-5 leading-relaxed">
                            <div class="space-y-2 leading-relaxed">Ya, sebagai mitra atau partner, Anda memiliki kendali
                                penuh atas penetapan harga produk Anda. Namun, kami mendorong Anda untuk menetapkan harga
                                yang bersaing dan sesuai dengan pasar</div>
                        </div>
                    </div>
                </li>
                <li>
                    <button
                        class="relative flex gap-2 items-center w-full py-5 text-base font-semibold text-left border-t md:text-lg border-base-content/10"
                        aria-expanded="false" onclick="toggleFAQ(this)">
                        <span class="flex-1 text-textbase text-base-content">Apakah saya bisa menjadi mitra atau partner di
                            platform ini jika saya berlokasi di luar wilayah operasional saat ini?</span>
                        <svg class="flex-shrink-0 w-4 h-4 ml-auto fill-current" viewBox="0 0 16 16"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect y="7" width="16" height="2" rx="1"
                                class="transform origin-center transition duration-200 ease-out false"></rect>
                    ...
                    <div class="transition-all duration-300 ease-in-out max-h-0 overflow-hidden"
                        style="transition: max-height 0.3s ease-in-out 0s;">
                        <div class="pb-5 leading-relaxed">
                            <div class="space-y-2 leading-relaxed">Kami terbuka untuk bekerja sama dengan mitra di berbagai
                                wilayah. Jika Anda berlokasi di luar wilayah operasional saat ini, silakan hubungi tim kami
                                untuk mendiskusikan kemungkinan kerja sama dan pengiriman produk ke wilayah Anda</div>
                        </div>
                    </div>
                </li>
            </ul>
