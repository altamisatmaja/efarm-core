...
@section('title', 'Ternak Express | Jual beli hewan')
                        ...
                        <div class="relative flex mt-10 flex-col bg-white ring-1 ring-primarybase w-full mb-4 rounded-lg">
                            <div class="bg-white rounded-lg">
                                <div class="py-8 px-10">
                                    <h1
                                        class="animate-typing overflow-hidden whitespace-nowrap border-r-4 border-r-textbase pr-3 text-4xl font-bold tracking-tight text-textbase sm:text-6xl">
                                        Beli hewan ternak dari rumah</h1>
                                    <p class="mt-3 text-xl leading-8 text-textbase">Kelola peternakan, jual hewan ternak,
                                        beli
                                        hewan
                                        ternak dengan berbagai layanan yang tersedia di Ternak Express</p>
                            ...
                            <div class="py-8 px-10">
                                <div class="flex flex-wrap items-center">
                                    ...
                                    <p class="text-3xl ml-2 font-semibold text-textbase leading-sm">
                                        Semua layanan Ternak Express
                                    </p>
                                </div>
                                <p class="text-xl text-textbase leading-sm mt-2">
                                    Pelajari lebih lanjut semua layanan Ternak Express untuk mengembangkan ternak Anda
                                </p>
                            </div>
                        </div>
                    </div>
