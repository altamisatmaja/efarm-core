...
@section('title', 'Customer | Order Show')
                ...
                <div
                    ...
                    <div class="space-y-4 p-6">
                        <div class="flex items-center gap-6">
                            ...
                            <a href="#"
                                class="min-w-0 flex-1 font-medium text-gray-900 hover:underline dark:text-white"> PC system
                                All in One APPLE iMac (2023) mqrq3ro/a, Apple M3, 24" Retina 4.5K, 8GB, SSD 256GB, 10-core
                                GPU, macOS Sonoma, Blue, Keyboard layout INT </a>
                        </div>
                    ...
                    <div class="space-y-4 p-6">
                        <div class="flex items-center gap-6">
                            ...
                            <a href="#"
                                class="min-w-0 flex-1 font-medium text-gray-900 hover:underline dark:text-white"> Restored
                    ...
                    <div class="space-y-4 p-6">
                        <div class="flex items-center gap-6">
                            ...
                            <a href="#"
                                ...
                                Playstation 5 Digital Edition Console with Extra Blue Controller, White PULSE 3D Headset and
                                Surge Dual Controller </a>
                        </div>
