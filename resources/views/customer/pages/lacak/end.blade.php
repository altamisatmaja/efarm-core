                ...
                <div class="space-y-6 rounded-lg border border-gray-200 bg-white p-6 shadow-sm  ">
                    ...
                    <div class="gap-4 sm:flex sm:items-center">
                        <a href="{{ route('customer.review', $allorder['slug_product']) }}"
                            class="w-full rounded-lg items-center flex justify-center  border border-gray-200 bg-white px-5  py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100">Review</a>
                        <a href="{{ route('testimonial.show', $allorder['slug_product']) }}"
                            class="w-full rounded-lg items-center flex justify-center  border border-gray-200 bg-white px-5  py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100">Ulas</a>
                    </div>
                </div>
            </div>
    </div>
