        ...
        @foreach ($allorders as $allorder)
            ...
            <div class="mt-6 sm:mt-8 lg:flex lg:gap-8">
                <div
                    ...
                    <div class="space-y-4 p-6">
                        ...
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <p class="text-sm font-normal text-gray-500 "><span
                                ...
                                class="font-medium text-gray-900 ">Dijual oleh </span>{{ $partner->nama_perusahaan_partner }}</p> @endforeach
                    ...
                    <div class="flex items-center justify-between gap-4">
                        <p class="text-sm font-normal text-gray-500 "><span
                                class="font-medium text-gray-900 ">Pengiriman dilakukan dengan
                    ...
                    <div class="flex items-center justify-between gap-4">
                        @foreach ($orderdetails['partner'] as $partner)
                            <p class="text-sm font-normal text-gray-500 "><span
                                    class="font-medium text-gray-900 ">Dikirim dari
                ...
                <div class="space-y-6 rounded-lg border border-gray-200 bg-white p-6 shadow-sm  ">
                    ...
                    <ol class="relative ms-3 border-gray-200 ">
                        <li class="mb-10 ms-6">
                            ...
                            <h4 class="mb-0.5 text-base font-semibold text-gray-900 ">Pesanan
                    ...
                    <div class="gap-4 sm:flex sm:items-center grid grid-col-2">
                        <a href""
                            ...
                            <form action="{{ route('customer.lacak.status', $allorder['order']['id']) }}" method="POST">
                                ...
                                <button type="submit" class="w-full rounded-lg items-center flex justify-center  border border-gray-200 bg-white px-5  py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100">Selesai</button>
                            </form>
                    </div>
                </div>
            </div>
