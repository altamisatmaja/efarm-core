            ...
            <div id="navBar"
                ...
                <div class="flex justify-center md:w-auto">
                    <div class="md:visible">
                        <a href="#"
                            class="text-sm px-1 font-medium text-textbase md:text-lg md:font-semibold md:ml-6">Hewan
                            Ternak</a>
                        <a href="#"
                            class="text-sm px-1 font-medium text-textbase md:text-lg md:font-semibold md:ml-6">Hewan
                            Kurban</a>
                        <a href="#"
                            ...
                            Aqiqah</a>
                        <a href="#"
                            class="text-sm px-1 font-medium text-textbase md:text-lg md:font-semibold md:ml-6">Sapi</a>
                        <a href="#"
                            class="text-sm px-1 font-medium text-textbase md:text-lg md:font-semibold md:ml-6">Kambing</a>
                    </div>
                </div>
            </div>
            <div class="p-4 md:p-4 md:w-60 hidden md:block h-auto" id="sideNav">
                <div class="bg-primarybase rounded-xl">
                    <nav class="flex flex-wrap mx-auto justify-center md:flex-col md:justify-start p-3">
                        ...
                        <div class="md:px-0 md:py-1 flex flex-wrap">
                            <a href="#"
                                class="md:my-3 text-white px-2 md:w-full pr-4  hover:bg-sekunderbase rounded-lg hover:text-textbase cursor-pointer md:px-3 md:py-2 md:font-semibold md:text-lg flex flex-wrap md:items-center"><svg
