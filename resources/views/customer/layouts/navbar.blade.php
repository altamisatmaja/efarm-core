                                            ...
                                            <a href="{{ route('homepage.partner') }}"
                                                ...
                                                <div class="items-center flex">
                                                    ...
                                                    <span class="flex flex-col">
                                                        ...
                                                        <span class="text-textbase text-sm">Jual hewan ternak
                                                            Anda</span>
                                                    </span>
                                                </div>
                                            </a>
                                            ...
                                            <li>
                                                <a href="{{ route('customer.account') }}"
                                                    ...
                                                    <div class="items-center flex">
                                                        ...
                                                        <span class="flex flex-col">
                                                            <span
                                                                class="text-textbase text-lg font-semibold">Pengaturan
                                                                Akun</span>
                                            ...
                                            <li>
                                                <a href="{{ route('customer.lacak') }}"
                                                    ...
                                                    <div class="items-center flex">
                                                        ...
                                                        <span class="flex flex-col">
                                                            <span
                                                                class="text-textbase text-lg font-semibold">Pesanan</span>
                                        ...
                                        <a href="{{ route('customer.dashboard') }}">
                                            <div class="p-4 text-lg font-medium border-t">
                                                <div class="items-center flex">
                                                    ...
                                                    <span class="flex flex-col">
                                                        <span
                                                            class="text-textbase text-lg font-semibold">Dashboard</span>
                                                    </span>
                                                </div>
                                            </div>
                                        </a>
