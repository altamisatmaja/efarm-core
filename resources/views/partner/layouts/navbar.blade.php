        ...
        <div class="hidden lg:flex lg:justify-between lg:items-center">
            <ul class="flex items-center space-x-1 font-semibold">
                ...
                <li><a href="{{ route('partner.farm.list') }}"
                        class="px-2 xl:px-4 py-2 text-textbase text-base rounded-md hover:bg-gray-200">Peternakan
                    </a>
                </li>
                <li><a href="{{ route('partner.report.list') }}"
                        class="px-2 xl:px-4 py-2 text-textbase text-base rounded-md hover:bg-gray-200">Laporan</a></li>
                <li><a href="/partner/testimonial"
                        class="px-2 xl:px-4 py-2 text-textbase text-base rounded-md hover:bg-gray-200">Ulasan</a></li>
                <li><a href="{{ route('partner.product.list') }}"
                        class="px-2 xl:px-4 py-2 text-textbase text-base rounded-md hover:bg-gray-200">Produk</a></li>
                    ...
                    <ul x-cloak x-show="open" x-transition
                        ...
                        <li>
                            <a href="{{ route('partner.order.master') }}"
                                class="p-4 text-textbase text-base rounded flex items-center gap-2 hover:bg-gray-100">
