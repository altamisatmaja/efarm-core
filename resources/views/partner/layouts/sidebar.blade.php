<aside
    ...
    <div class="relative border-b border-white/20">
        <div class="flex items-center justify-center my-5">
            <a href="{{ route('partner.dashboard') }}" class="flex items-start gap-2 group">
                <img src="{{ asset('efarm-partner.png') }}" alt="" class="w-32">
            </a>
        </div>
    </div>
    <div class="relative border-b border-white/20">
        <div class="flex items-center p-5">
            ...
            <div class="mr-2 ">
                <a href="javascript:void(0)"
                    class="dark:hover:text-primary hover:text-primary transition-colors duration-200 ease-in-out text-[1.075rem] font-medium dark:text-neutral-400/90 text-secondary-inverse">Robert
                    Jason</a>
                <span class="text-secondary-dark dark:text-stone-500 font-medium block text-[0.85rem]">SEO
                    Manager</span>
            </div>
        </div>
    </div>
    <div class="m-4">
        ...
        <ul class="mb-4 flex flex-col gap-1">
            ...
            <li>
                <a class="" href="{{ route('partner.logout') }}">
                    <button
                        class="middle none font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg text-white hover:bg-white/10 active:bg-white/30 w-full flex items-center gap-4 px-4 capitalize"
                        type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px"
