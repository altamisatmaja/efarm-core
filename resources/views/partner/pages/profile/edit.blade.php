            ...
            <form action="{{ route('partner.account.update') }}" method="POST">
                ...
                <div class="mt-2 mb-4 w-full">
                    ...
                    <p class="mt-2 px-2 text-base text-gray-600">
                        Hati-hati dalam mengubah informasi akun
                    </p>
                </div>
                <div class="grid grid-cols-2 gap-4 w-full">
                    <div
                        ...
                        <label for="nama" class="text-sm text-gray-600 mb-4">Nama</label>
                        <input name="nama" id="nama" class="border p-2 rounded-lg w-full" type="text"
                            value="{{ $user->nama }}">
                    </div>
                    ...
                    <div
                        ...
                        <label for="username" class="text-sm text-gray-600 mb-4">Username</label>
                        <input name="username" id="username" class="border p-2 rounded-lg w-full" type="text"
                            value="{{ $user->username }}">
                    </div>
                ...
                <div
                    class="flex flex-col items-start justify-center rounded-2xl bg-white bg-clip-border px-3 py-4 shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
                    <label for="email" class="text-sm text-gray-600 mb-4">Email</label>
                    <input name="email" id="email" class="border p-2 rounded-lg w-full" type="text"
                        value="{{ $user->email }}">
                    <button type="submit"
